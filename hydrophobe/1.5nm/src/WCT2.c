...
int main(int argc, char *argv[]) 
{
 ...
 /*defining the logarithmic part*/ 
  ...
  for (i=15.10;i<=30.0;i+=0.01) { 
    
    r = i;
    /*The component for the hydrophilic nanoparticle*/
    LJ1=LeJ124(4.2960,0.2900,r,pi,waterden,R);
    /*The component for the hydrophobic nanoparticle*/
    LJ2=LeJ96(4.2210,0.31200,r,pi,CT2den,R);
    newLJ = (1.0-k)*LJ1 + k*(LJ2);
    /*The component for the hydrophilic nanoparticle*/
    inter1=interaction124(4.2960,0.2900,r,pi,waterden,R);
    /*The component for the hydrophobic nanoparticle*/ 
    inter2=interaction96(4.2210,0.31200,r,pi,CT2den,R);
    newinter = (1-k)*inter1 + k*(inter2); 

    //gradient = -(LeJ96(4.2210,0.31200,r+0.02,pi,CT2den,R) - LeJ96(4.2210,0.31200,r,pi,CT2den,R))/0.02;
    j++; 

    /*defining the logarithmic part*/ 


    printf("%d %lf %lf %lf  \n",j,r,newLJ+0.006176,newinter); 
