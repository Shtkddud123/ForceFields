...
{ 
  ...
  bepsilon = 0.1004; /*These are parameters for CH2. Checked for correction on 20th of july*/ 
  bsigma = 4.0500; /*ditto*/ 
  cepsilon = 0.1960; /*these are parameters for CH3*/
  csigma = 3.75; /*ditto*/ /*Checked for corrections on 20th of July*/  
  ...
  for (i=35;i<200;i++) { 
    ...
    for (j=0;j<n;j++) {
      ...
      bf=1.0;
 /*We are assuming for now sigma for the COM is identical to that of ab,ac,and ad*/ 
