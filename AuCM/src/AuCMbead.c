...
{ 
  ...
  /* b is CH2! */ 
  bondlength = 1.53; 
  bondangle = 113.60*(3.14159/180); 
  bx = 0.0;
  by = 0.0; 
  bz = 3.67; /*This was calculated by dividing the R_min value of CT2 by 2^1/6*/ 
  ...
  bepsilon = 0.1004; /* taken from klein et al, 2008, in Kcal mol^-1*/
  bsigma = 4.05;  /*calculated from a R/2 value of 2.2730 angstoms*/
  cepsilon = 0.1004; /*ditto*/ /*Corrected on the 20th July*/
  csigma = 4.05;  /*ditto*/ /*Corrected on the 20th July*/
  depsilon = 0.1004; /*ditto*/ /*ditto*/
  dsigma = 4.05; /*ditto*/ /*ditto*/
