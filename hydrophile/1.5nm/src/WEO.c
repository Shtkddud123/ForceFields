...
int main(int argc, char *argv[]) 
{
  ...
  double inter2;
  double newinter;
  double k = 0; /*k defines the proportion of hydrophil/hydrophobicity.*/
 ...
 /*defining the logarithmic part*/ 
  ...
  for (i=15.10;i<=30.0;i+=0.01) { 
    ...
    LJ2=LeJ96(4.2960,0.2900,r,pi,CT2den,R);
    newLJ = (1.0-k)*LJ1 + k*(LJ2);
    /*The component for the hydrophilic nanoparticle*/
    inter1=interaction124(4.31000,0.57000,r,pi,waterden,R);
    /*The component for the hydrophobic nanoparticle*/ 
    inter2=interaction96(4.2960,0.2900,r,pi,CT2den,R);
