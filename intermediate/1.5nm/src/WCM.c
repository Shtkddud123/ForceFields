...
int main(int argc, char *argv[]) 
{
 ...
 /*defining the logarithmic part*/ 
  ...
  for (i=15.10;i<=30.0;i+=0.01) { 
    ...
    LJ1=LeJ124(4.4385,0.3400,r,pi,waterden,R);
    /*The component for the hydrophobic nanoparticle*/
    LJ2=LeJ96(4.3635,0.3620,r,pi,CT2den,R);
    newLJ = (1.0-k)*LJ1 + k*(LJ2);
    /*The component for the hydrophilic nanoparticle*/
    inter1=interaction124(4.4385,0.3400,r,pi,waterden,R);
    /*The component for the hydrophobic nanoparticle*/ 
    inter2=interaction96(4.3635,0.3620,r,pi,CT2den,R);
